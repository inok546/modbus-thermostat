...
#define SDIO_D0_PIN_NUM			8	// PC8
#define SDIO_D1_PIN_NUM			9	// PC9
#define SDIO_D2_PIN_NUM			10	// PC10
#define SDIO_D3_PIN_NUM			11	// PC11
#define SDIO_CLK_PIN_NUM		12	// PC12
#define SDIO_CMD_PIN_NUM		2	// PD2
